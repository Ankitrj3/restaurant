...
# Search for any node/way with names containing Chowrastha or Hashtag
query = f"""
[out:json][timeout:15];
(
  node(around:{radius_meters},{lat},{lng})["name"~"Chowrastha|Hashtag",i];
  way(around:{radius_meters},{lat},{lng})["name"~"Chowrastha|Hashtag",i];
);
out center;
"""
